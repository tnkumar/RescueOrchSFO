...
def main():
    ...
    try:
        ...
        print("[tiago_api_2] ✓ Grippers initialized")
    except:
    ...
    print(f"[tiago_api_2] Polling API at {api_url}/tiago/2/command")
    ...
    while robot.step(timestep) != -1:
        ...
        if poll_counter >= 1:
            ...
            if cmd:
                ...
                if cmd_type == "velocity":
                    ...
                    print(f"[tiago_api_2] ⬆️ TORSO command: height={height:.2f}m")
                elif cmd_type == "arm":
                    ...
                    if gripper:
                        if action == "open":
                            ...
                            print(f"[tiago_api_2] ✋ GRIPPER command: {arm_side} → OPEN")
                        elif action == "close":
                            gripper.setPosition(0.0)  # Closed position
                            print(f"[tiago_api_2] ✊ GRIPPER command: {arm_side} → CLOSE")
        ...
        if pos_counter >= 31:
            ...
            if pos and len(pos) >= 3:
                send_position(api_url, "2", pos[0], pos[1], pos[2])
